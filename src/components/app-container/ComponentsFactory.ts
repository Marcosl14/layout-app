...
export default class ComponentFactory {
    ...
    private search(): {
        create: (inputParameter: InputParametersInterface) => RawHTMLConponent,
        isContainer: boolean
    } {
        const componentsIndex = {
            ...
            'THEAD': {
                create: ({
                    ...
                    return new TableHead(createNewHTMLComponentPublisher, isLoaded);
                },
                isContainer: true,
            },
            'TBODY': {
                create: ({
                    ...
                    return new TableBody(createNewHTMLComponentPublisher, isLoaded);
                },
                isContainer: true,
            },
            'TFOOT': {
                create: ({
                    ...
                    return new TableFoot(createNewHTMLComponentPublisher, isLoaded);
                },
                isContainer: true,
            },
            'TR': {
        ...
        return componentsIndex[this.index] || componentsIndex['default'];
    }
}
